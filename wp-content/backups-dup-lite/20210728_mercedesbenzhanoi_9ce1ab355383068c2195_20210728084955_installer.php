...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210728_mercedesbenzhanoi_9ce1ab355383068c2195_20210728084955_archive.zip';
	const ARCHIVE_SIZE		 = '156419179';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9ce1ab3-28084955';
    const SECONDARY_PACKAGE_HASH = '43a8b06-28084955';
	const VERSION			 = '1.4.2';
